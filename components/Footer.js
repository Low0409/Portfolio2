            ...
            <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
                    <div class="col-span-full lg:col-span-2">
                        ...
                        <p class="text-gray-400 sm:pr-8 mb-6">kitagawa0409@icloud.com</p>
                        ...
                        <div class="flex gap-4">
                            ...
                            <a href="https://github.com/Low0409" target="_blank" class="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
                                <svg class="w-5 h-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="text-gray-400 text-sm text-center border-t border-gray-800 py-8">© 2022 - low0409</div>
            </footer>
        </div>
    )
}
